  ...
  return (
    <MantineProvider
      ...
      theme={{
        colorScheme: "light",
        primaryColor: "meldrx",
        colors: meldRxColorScheme,
      }}
    >
      <AppShell
        styles={{
          main: { background: theme.colors.white, paddingTop: 20 },
        }}
        padding={0}
        fixed={true}
        navbar={
          (!isRootPage && navbarOpen && (
            <AppNavbar closeNavbar={closeNavbar} />
